  ...
  return (
    <aside className="w-64 bg-slate-900 h-screen sticky top-0 text-slate-300 flex flex-col hidden md:flex">
      <div className="p-6 flex items-center gap-3 border-b border-slate-800">
        ...
        <div>
          <h1 className="text-white font-bold text-lg leading-tight tracking-tight">Tecnoperfil</h1>
          <p className="text-[10px] text-slate-500 uppercase font-black tracking-[0.2em]">Sistemas Alumínio</p>
        </div>
      </div>
